...
export class AutoWriteController {
     ...
     * gesetzt und genauso auch wenn die Marke bereits
     * existieren.
     *
     ...
     * Statuscode `400` (`Bad Request`) gesetzt und genauso auch wenn die neue Marke bereits existieren.
     *
    ...
    #handleCreateError(err: CreateError, res: Response) {
        switch (err.type) {
            ...
            case 'MarkeExists': {
                return this.#handleMarkeExists(err.marke, res);
            }
    ...
    #handleMarkeExists(
        ...
        const msg = `Die Marke "${marke}" existiert bereits.`;
        this.#logger.debug('#handleMarkeExists(): msg=%s', msg);
        return res
